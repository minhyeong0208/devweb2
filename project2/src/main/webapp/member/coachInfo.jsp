...
<div class="container">
	<div class="top-section">
        <input type="button" class="coachadd" value="코치 추가" onclick="addCoach()">
    </div>
    <%
            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    ...
                    <div class="button-container">
	                    <input type="button" class="coachbtn" value="수정" onclick="editCoach(<%= coach.getCode() %>)">
	                    <input type="button" class="coachbtn" value="삭제" onclick="deleteCoach(<%= coach.getCode() %>)">
	                </div>
                </div>
            </div>
            <% } %>
