...
<link href="../css/coachUpdate.css" rel="stylesheet" type="text/css">
...
%>
       ...
       <div class="button-container">
            <input type="button" class="coachbtn" value="닫기" onclick="closeWindow()">
        </div>
<%
    } else {
%>
<div class="coach-update-container">
    ...
    <h1>코치 수정</h1>
        ...
        <div class="button-container">
            <button class="coach-update-btn" type="submit">저장</button>
            <button class="coach-update-btn delete" type="button" onclick="window.close()">취소</button>
        </div>
    </form>
    <% if (!errorMsg.isEmpty()) { %>
